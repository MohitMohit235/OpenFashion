...
fun TshirtCard(
    ...
    val items = listOf(
            Items(
                    ...
                    image = painterResource(R.drawable.images10),
                    price = 120
            ),
            Items(
                    title = "Oblong bag",
                    image = painterResource(R.drawable.images11),
                    price = 120
            ),
            Items(
                    title = "21WN reversible angora cardigan",
                    image = painterResource(R.drawable.images12),
                    price = 120
            ),
            Items(
                    title = "21WN reversible angora cardigan",
                    image = painterResource(R.drawable.images13),
                    price = 120
            ),
    )
